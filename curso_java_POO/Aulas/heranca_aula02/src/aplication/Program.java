/* Nesta aula mostra como criar uma aplicação que utiliza herança de classes.
 * Desta vez, duas classes são recebem heranças da classe Account: BusinessAcount e SavingsAccount
 * */
